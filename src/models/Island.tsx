...
export function Island({
    ...
    const handlePointerMove = (event: any) => {
        ...
        if (props.isRotating) {
            ...
            (islandRef && "current" in islandRef && islandRef.current) && (islandRef.current.rotation.y += delta * 0.01 * Math.PI);
    ...
    const handleKeyDown = (event: any) => {
        if (event.key === "ArrowLeft") {
            ...
            (islandRef && "current" in islandRef && islandRef.current) && (islandRef.current.rotation.y += 0.005 * Math.PI);
    ...
    useFrame(() => {
        ...
        if (!props.isRotating) {
            ...
            (islandRef && "current" in islandRef && islandRef.current) && (islandRef.current.rotation.y += rotationSpeed.current);
        } else {
            // When rotating, determine the current stage based on island's orientation
            const rotation: any = (islandRef && "current" in islandRef && islandRef.current) && islandRef.current.rotation.y;
